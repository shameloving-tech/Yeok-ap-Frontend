...
const cardStyles = StyleSheet.create({
  ...
  timeText: { fontSize: 13, fontWeight: '700', color: '#3A3A3C' },
  segment: {
    flexDirection: 'row',
    alignItems: 'center',
    marginBottom: 6,
...
const sheetStyles = StyleSheet.create({
  ...
  centerText: { fontSize: 14, color: '#636366', fontWeight: '600' },
  retryBtn: { borderWidth: 1.5, borderRadius: 20, paddingHorizontal: 20, paddingVertical: 8, marginTop: 4 },
