...
const styles = StyleSheet.create({
  ...
  lineBadgeText: { color: 'white', fontSize: 16, fontWeight: '800' },
  stationName: { fontSize: 20, fontWeight: '800', color: COLORS.textMain },
  ...
  currentLabel: { fontSize: 14, color: COLORS.textSub, fontWeight: '600' },
  currentBadge: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 12 },
  currentBadgeText: { fontSize: 14, fontWeight: '800' },
  chartTitle: {
    fontSize: 15,
    fontWeight: '700',
